...
urlpatterns = [
    ...
    url(r'^company/dashboard-second/',views.companydashboard2,name='companydashboard2'),
    url(r'^company/docs/',views.companydocs,name='companydocs'),
    url(r'^company/docs-second/',views.companydocs2,name='companydocs2'),
    url(r'^company/checkout/',views.companycheckout,name='companycheckout'),
    url(r'^company/checkout-second/',views.companycheckout2,name='companycheckout2'),
    url(r'^company/progress/',views.companyprogress,name='companyprogress'),
    url(r'^company/progress-second/',views.companyprogress2,name='companyprogress2'),
    ...
    url(r'^company/instructions/',views.companyprocedure,name="process"),
    url(r'^company/instructions-second/', views.companyprocedures2, name="process2"),
